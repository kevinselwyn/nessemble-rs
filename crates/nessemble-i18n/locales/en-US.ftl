...
project-root-unresolved = `{ $file }` uses `@/`, but no project root could be determined
...
# The `-h`/`--help` usage text is generated by clap; only the version/license
# banner's copyright line is rendered from a locale string.
