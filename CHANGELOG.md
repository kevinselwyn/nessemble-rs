...
- Support line continuation in comma-separated data directives. A trailing comma
  at the end of a line now continues the operand list onto the next (indented)
  line, so a long run can be wrapped across several lines:
